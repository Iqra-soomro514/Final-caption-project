  ...
  return (
    <Box className="!w-full !py-20 mt-80 lg:mt-0">
      <Box
        ...
        sx={{ maxWidth: "1200px", paddingLeft: "1rem", paddingRight: "1rem" }}
      >
      ...
      <Box className="container mx-auto" sx={{ maxWidth: "1200px" }}>
        <Swiper
          slidesPerView={4}
          spaceBetween={20}
        ...
        >
          {product.map((item) => (
            <SwiperSlide
              key={item.id}
              className="bg-white rounded-2xl cursor-pointer drop-shadow-md"
            >
              <Box className="flex flex-col justify-center items-center">
                ...
                <Box className="relative">
                  <img
                    className="w-20 lg:w-24 bg-white p-3 mt-[-20px] drop-shadow-md rounded-lg"
                    src={item.image}
                    alt={item.title}
                  />
                </Box>
